...
**1,591단어 / 30 DAY** — 표제어, 품사, 뜻, 예문(일부 해석), 연어.

## 구조

```
crawl.py              수집 스크립트 (파이썬 표준 라이브러리만)
make_icons.py         PWA 아이콘 생성 (외부 라이브러리 없이 PNG 직접 작성)
data/words.json       수집 원본
...
퀴즈(4지선다), 설정. 출제 방향(영→한 / 한→영 / 혼합)은 플래시카드와 퀴즈에
