...
TRUNCATED_FIXES = {
    ...
    "괜찮은, 품질이 나쁘지 않": "괜찮은, 품질이 나쁘지 않은",
    "비밀스럽고 정직하지 않": "비밀스럽고 정직하지 않은",
    "학장 (특정 학과나 단과": "학장 (특정 학과나 단과대의 장)",
    "법적 문서, 증서(특히 부": "법적 문서, 증서 (특히 부동산 관련)",
    "자극하다 (피부나 신체 일": "자극하다 (피부나 신체 일부를)",
    "(확률이나 운에 의존하는": "복권 (확률이나 운에 의존하는 것)",
    "나누어지는 수 (수학적 용": "나누어지는 수 (수학 용어)",
}
